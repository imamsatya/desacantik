                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <breeze-nav-link :href="route('createtable')" :active="route().current('createtable')">
                                    Create Table
                                </breeze-nav-link>
                            </div>
                        </div>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        <breeze-responsive-nav-link :href="route('dashboard')" :active="route().current('dashboard')">
                         ...
                         <breeze-responsive-nav-link :href="route('createtable')" :active="route().current('dashboard')">
                            Create Table
                        </breeze-responsive-nav-link>
                    </div>
